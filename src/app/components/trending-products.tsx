    ...
    <div className="w-full bg-white py-20">
      ...
      <div className="w-full max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-pink-100 p-8 flex flex-col justify-between relative h-[200px]">
         ...
         <Link href={"/Shop"}> <button className="text-pink-600 underline text-lg font-medium">Shop Now</button></Link>
          <Image
            src="/voucher1.png"
            alt="Voucher Image"
            width={180}
        ...
        <div className="bg-pink-100 p-8 flex flex-col justify-between relative h-[200px]">
          <h3 className="text-[#3F509E] text-2xl font-bold mb-4">23% Off in all products</h3>
   {/* Button */}
   <Link href={'/Shop'}><button  className="text-pink-600 underline text-lg font-medium mt-4">
    View Collection
  </button></Link>
          <Image
            src="/voucher2.png"
